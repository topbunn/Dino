...
object FeedbackScreen: Tab {
    ...
    override val options: TabOptions
        @Composable get() = TabOptions(2U, stringResource(ru.topbun.ui.R.string.tabs_feedback), painterResource(ru.topbun.ui.R.drawable.ic_tabs_feedback))
    ...
    override fun Content() {
        Column(
            ...
            val messageSent = stringResource(ru.topbun.ui.R.string.message_is_sent)
            ...
            Text(
                ...
                text = stringResource(ru.topbun.ui.R.string.contact_us),
            ...
            Text(
                modifier = Modifier.fillMaxWidth(),
                text = stringResource(ru.topbun.ui.R.string.any_question),
                style = Typography.APP_TEXT,
                fontSize = 24.sp,
                color = Colors.GRAY,
                textAlign = TextAlign.Center,
            ...
            AppTextField(
                value = name,
                placeholder = stringResource(ru.topbun.ui.R.string.name),
